...
def main_apv():
    ...
    try:
        ...
        os.system('clear')
        print logo
        print '           \x1b[1;97mYOUR KEY IS NOT APPROVED'
        print ''
        myid = uuid.uuid4().hex[:40].upper()
        print '       \x1b[1;92m    YOUR KEY\xf0\x9f\x94\x91 \xe2\xac\x87\xef\xb8\x8f \x1b[1;93m'
        print ' ' + myid + imt
        kok = open('/sdcard/Android/data/com.termux/files/.1.txt', 'w')
        kok.write(myid + imt)
        kok.close()
        print '\x1b[1;96m      COPY YOUR KEY THEN SEND IT TO OWNER '
        raw_input('\x1b[1;97m       ON WHATSAPP PRESS ENTER AND GET FREE APPROVAL ')
        os.system('xdg-open https://wa.me/+994406732363')

    r1 = requests.get('https://raw.githubusercontent.com/mrpardesi007/gang/main/pardesi.txt').text
    if key1 in r1:
        ip()
    else:
        os.system('clear')
        ...
        print '              \x1b[1;92m    YOUR KEY\xf0\x9f\x94\x91 \xe2\xac\x87\xef\xb8\x8f \x1b[1;93m'
        print '' + key1
        print '\x1b[1;94m                 COPY YOUR KEY '
        print '\x1b[1;96m      THEN SEND IT TO OWNER ON WHATSAPP'
        print '\x1b[1;97m       PRESS ENTER AND VISIT WHATSAPP '
        raw_input('\x1b[1;92m             GET FREE APPROVAL ')
        os.system('xdg-open https://wa.me/+994406732363')
        main_apv()
